const recipes = [
    {
      ...
      appliance: 'Blender',
      devices: ['cuillère à Soupe', 'verres', 'presse citron'],
    },
    {
      id: 2,
    ...
    },
    {
      ...
      appliance: 'Four',
      devices: ['moule à tarte', 'râpe à fromage', 'couteau'],
    },
    {
      id: 6,
      ...
      appliance: 'Four',
      devices: ['moule à tarte', 'saladier', 'fourchette'],
    },
    {
      id: 7,
      ...
      appliance: 'Four',
      devices: ['moule à tartelettes', 'casserole'],
    },
    {
      id: 8,
      name: 'Brownie',
      ...
      appliance: 'Four',
      devices: ['moule à gateaux', 'casserole'],
    },
    {
      id: 9,
      ...
      appliance: 'Saladier',
      devices: ['cuillère en bois', 'couteau'],
    },
    {
      id: 10,
      name: 'Tartiflette',
      ...
      appliance: 'Four',
      devices: ['plat à gratin', 'couteau', 'Économe'],
    },
    {
      id: 11,
      ...
      appliance: 'Saladier',
      devices: ['couteau', 'cuillère à melon'],
    },
    {
      id: 12,
    ...
    },
    {
      ...
      appliance: 'Casserole',
      devices: ['couteau', 'saladier', 'cuillère en bois'],
    },
    {
      id: 14,
    ...
    },
    {
      ...
      devices: ['saladier', 'louche', 'cuillère en bois'],
    },
    {
      id: 16,
      ...
      appliance: 'Four',
      devices: ['plat à gratin', 'couteau', 'râpe à fromage'],
    },
    {
      id: 17,
      ...
      appliance: 'Blender',
      devices: ['verres', 'couteau', 'presse citron'],
    },
    {
      id: 18,
    ...
    },
    {
      ...
      appliance: 'Blender',
      devices: ['couteau', 'verres', 'presse citron'],
    },
    {
      id: 20,
      ...
      appliance: 'Sauteuse',
      devices: ['râpe à fromage', 'cuillère en bois'],
    },
    {
      id: 21,
      ...
      appliance: 'Casserole.',
      devices: ['Cuillère en bois', 'louche', 'couteau'],
    },
    {
      id: 22,
      ...
      appliance: 'Four',
      devices: ['moule à gateaux', 'fouet', 'casserolle'],
    },
    {
      id: 23,
      ...
      appliance: 'Four',
      devices: ['moule à gateaux', 'rouleau à patisserie', 'fouet'],
    },
    {
      id: 24,
      ...
      appliance: 'Saladier',
      devices: ['couteau', 'cuillère en bois'],
    },
    {
      id: 25,
      name: 'Cookies',
      ...
      appliance: 'Four',
      devices: ['fouet', 'saladier', 'plaque de cuisson'],
    },
    {
      id: 26,
      ...
      appliance: 'Mixer',
      devices: ['cocotte minute', 'couteau'],
    },
    {
      id: 27,
    ...
    },
    {
      ...
      appliance: 'Mixer',
      devices: ['cuillère en bois', 'presse citron'],
    },
    {
      id: 30,
      ...
      appliance: 'Mixer',
      devices: ['casserole', 'cuillère en bois'],
    },
    {
      id: 31,
    ...
    },
    {
      ...
      appliance: 'Four',
      devices: ['râpe à fromage', 'cuillère à Soupe', 'couteau'],
    },
    {
      id: 33,
    ...
    },
    {
      ...
      appliance: 'Mixer',
      devices: ['couteau', 'économe', 'cuillère en bois'],
    },
    {
      id: 35,
      ...
      appliance: 'Mixer',
      devices: ['cocotte minute', 'couteau', 'cuillère en bois'],
    },
    {
      id: 36,
      ...
      appliance: 'Four',
      devices: ['plat à gratin', 'râpe à fromage', 'fouet'],
    },
    {
      id: 37,
      ...
      appliance: 'Four',
      devices: ['couteau', 'cuillère en bois', 'Poêle à frire'],
    },
    {
      id: 38,
      name: 'Pain Perdu',
      ...
      appliance: 'Four',
      devices: ['fouet', 'bol', 'cuillère à Soupe'],
    },
    {
      id: 39,
      ...
      appliance: 'Four',
      devices: ['saladier', 'couteau', 'fouet'],
    },
    {
      id: 40,
      name: 'Limonade',
    ...
    },
    {
      ...
      appliance: 'Four',
      devices: ['rouleau à patisserie', 'moule à tarte', 'presse citron'],
    },
    {
      id: 44,
    ...
    },
    {
      ...
      appliance: 'Saladier',
      devices: ['fouet', 'verres', 'cuillère en bois'],
    },
    {
      id: 48,
      name: 'Pizza',
      ...
      appliance: 'Four',
      devices: ['rouleau à patisserie', 'râpe à fromage', 'couteau'],
    },
    {
      id: 49,
    ...
    },
    {
      ...
      appliance: 'Four',
      devices: ['rouleau à patisserie', 'fouet'],
    },
  ];
